...
export default {
  ...
  data() {
    return {
      url: "http://132.102.126.71:6889/ivenus/data/api/stream/monitoring/density/list_by_street?token=w&"
      //url:"http://10.123.60.101:6889/ivenus/data/api/stream/monitoring/density/list_by_street?token=w&"
  ...
  methods: {
    initDom() {
      this.myChart = this.echarts.init(document.querySelector(".density-jd"));
